...
section
  ...
  .container.tarjeta.tarjeta__template--azul-claro.p-4.p-md-5.mb-5(data-aos="fade-up")
    ...
    p.mb-3  El programa técnico en programación de aplicaciones para dispositivos móviles busca formar talento humano con las competencias y las habilidades requeridas por la industria del desarrollo de software para dispositivos móviles.
